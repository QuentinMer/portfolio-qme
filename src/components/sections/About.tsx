...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="
        py-24 md:pt-10 flex md:flex-row flex-col
        scroll-mt-24 md:scroll-mt-32 xl:scroll-mt-40
      "
    >
      <I18nImage
        basePath="/img/about"
      ...
      <div className="my-auto md:pb-10">
        <p className="text-start text-slate-100 xl:text-4xl text-2xl font-family-decifer tracking-widest mx-12 my-auto leading-relaxed">
          {t("about.quote")}
        </p>
